...
const NEBULA_WAVES: ShmupWave[] = [
  {
    ...
    enemies: [
      ...
      { delayMs: 520, x: 0.42, pattern: "drifter", vx: -10, vy: 118, hp: 2, scoreValue: 190 },
      { delayMs: 520, x: 0.58, pattern: "drifter", vx: 10, vy: 118, hp: 2, scoreValue: 190 },
  ...
  },
  {
    ...
    enemies: [
      ...
      { delayMs: 240, x: 0.5, pattern: "drifter", vy: 130, hp: 2, scoreValue: 190 },
  ...
  },
  {
    ...
    enemies: [
      ...
      { delayMs: 180, x: 0.5, pattern: "drifter", vy: 120, hp: 2, scoreValue: 180 },
  ...
  },
  {
    ...
    enemies: [
      ...
      { delayMs: 280, x: 0.5, pattern: "sine", vy: 96, amplitude: 52, frequency: 2.2, hp: 3, scoreValue: 280 },
      { delayMs: 420, x: 0.66, pattern: "sine", vy: 92, amplitude: 48, frequency: 2.3, hp: 3, scoreValue: 260 },
      { delayMs: 560, x: 0.82, pattern: "sine", vy: 90, amplitude: 44, frequency: 2.4, hp: 3, scoreValue: 260 },
...
const SOLAR_WAVES: ShmupWave[] = [
  {
    ...
    enemies: [
      ...
      { delayMs: 200, x: 0.5, pattern: "drifter", vy: 130, hp: 3, scoreValue: 230 },
      { delayMs: 400, x: 0.38, pattern: "drifter", vx: -26, vy: 124, hp: 2, scoreValue: 200 },
      { delayMs: 400, x: 0.62, pattern: "drifter", vx: 26, vy: 124, hp: 2, scoreValue: 200 },
      ...
      { delayMs: 820, x: 0.5, pattern: "sine", vy: 94, amplitude: 44, frequency: 2.6, hp: 3, scoreValue: 270 },
    ],
  },
  {
    id: "heat-lattice",
  ...
  },
  {
    ...
    enemies: [
      ...
      { delayMs: 340, x: 0.5, pattern: "drifter", vy: 136, hp: 3, scoreValue: 220 },
      ...
      { delayMs: 700, x: 0.64, pattern: "sine", vy: 92, amplitude: 52, frequency: 2.8, hp: 3, scoreValue: 270 },
  ...
  },
  {
    ...
    enemies: [
      ...
      { delayMs: 520, x: 0.78, pattern: "sine", vy: 90, amplitude: 46, frequency: 2.4, hp: 3, scoreValue: 260 },
...
const ABYSS_WAVES: ShmupWave[] = [
  {
    ...
    enemies: [
      ...
      { delayMs: 200, x: 0.3, pattern: "drifter", vx: 30, vy: 122, hp: 2, scoreValue: 200 },
      { delayMs: 200, x: 0.7, pattern: "drifter", vx: -30, vy: 122, hp: 2, scoreValue: 200 },
      { delayMs: 400, x: 0.24, pattern: "sine", vy: 90, amplitude: 48, frequency: 2.5, hp: 3, scoreValue: 260 },
      { delayMs: 400, x: 0.76, pattern: "sine", vy: 90, amplitude: 48, frequency: 2.5, hp: 3, scoreValue: 260 },
  ...
  },
  {
    ...
    enemies: [
      ...
      { delayMs: 280, x: 0.4, pattern: "drifter", vx: -22, vy: 128, hp: 3, scoreValue: 220 },
  ...
  },
  {
    ...
    enemies: [
      ...
      { delayMs: 0, x: 0.78, pattern: "sine", vy: 88, amplitude: 66, frequency: 2.9, hp: 3, scoreValue: 260 },
      { delayMs: 140, x: 0.5, pattern: "drifter", vy: 130, hp: 3, scoreValue: 220 },
      ...
      { delayMs: 520, x: 0.16, pattern: "drifter", vx: 56, vy: 134, hp: 2, scoreValue: 200 },
      { delayMs: 520, x: 0.84, pattern: "drifter", vx: -56, vy: 134, hp: 2, scoreValue: 200 },
      { delayMs: 740, x: 0.5, pattern: "orbiter", vy: 84, amplitude: 72, frequency: 2.7, hp: 5, scoreValue: 360, fireCooldown: 0.74 },
      { delayMs: 740, x: 0.34, pattern: "sine", vy: 92, amplitude: 40, frequency: 2.6, hp: 3, scoreValue: 260 },
    ],
  },
  {
    id: "polar-break",
    ...
    enemies: [
      ...
      { delayMs: 0, x: 0.5, pattern: "drifter", vy: 126, hp: 2, scoreValue: 200 },
      ...
      { delayMs: 500, x: 0.38, pattern: "zigzag", vy: 110, amplitude: 56, frequency: 4.2, hp: 3, scoreValue: 250 },
      { delayMs: 500, x: 0.62, pattern: "zigzag", vy: 110, amplitude: 56, frequency: 4.2, hp: 3, scoreValue: 250 },
